...
This mechanism has been integrated into Bitcore-Node-NatisCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/natiscoinpay/insight-api-natiscoin#web-socket-api](https://github.com/natiscoinpay/insight-api-natiscoin#web-socket-api)
* API: [https://github.com/natiscoinpay/insight-api-natiscoin#instantsend-transactions](https://github.com/natiscoinpay/insight-api-natiscoin#instantsend-transactions)
...
By default, the NatisCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the NatisCoin Core daemon:
