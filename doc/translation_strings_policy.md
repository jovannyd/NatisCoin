...
This document provides guidelines for internationalization of the NatisCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `natiscoin_en.ts` remains unchanged.
