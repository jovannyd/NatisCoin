    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  natiscoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the NatisCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 NAT, 0.1 NAT, 1 NAT and 10 NAT -- sort of like the paper money you use every day.</li> \
