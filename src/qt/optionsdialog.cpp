    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("NAT-light"), QVariant("light"));
    ui->theme->addItem(QString("NAT-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("NAT-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("NAT-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("NAT-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("NAT-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("NAT-traditional"), QVariant("trad"));
