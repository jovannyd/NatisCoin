...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid natiscoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid natiscoin address" in e.error['message'])
