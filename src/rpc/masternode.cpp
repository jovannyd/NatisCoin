...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print NatisCoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "natiscoin",               "masternode",             &masternode,             true,  {} },
    { "natiscoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "natiscoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "natiscoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "natiscoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "natiscoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
